...
export default function AnnouncementBar() {
  ...
  return (
    <div className="relative bg-[#E51B23] text-white text-xs font-sans">
      <div className="max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-center gap-3">
        ...
        <a href="#pricing" className="hidden sm:inline-flex items-center gap-1 text-white border border-white/40 px-3 py-1 hover:bg-white hover:text-[#E51B23] transition-colors text-[11px] tracking-wide">
          立即预约 &rsaquo;
        </a>
      </div>
      <button
