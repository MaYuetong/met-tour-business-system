export default function MetLogo({ className = "h-8 w-auto" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 151.2 150.6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-label="The Met">
