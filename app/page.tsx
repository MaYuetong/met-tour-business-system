...
const STATIC_TESTIMONIALS = [
  {
    quote: "之前自己来过两次，每次都是走马观花，看完啥也没记住。这次跟着历史线走才发现原来这样看才对，前后一串联起来一下就懂了。",
    name: "蒋女士",
    detail: "来自深圳",
  },
  {
    quote: "带着16岁的女儿一起来，女儿比较好奇。讲解的节奏舒适，随时可以细看，很值得。",
    name: "Cathy Wong",
    detail: "来自西雅图",
  },
];
          ...
          <div className="grid md:grid-cols-2 gap-0 border border-[#E0D5C8] mb-8">
            ...
            <div className="bg-[#A6192E] p-10 relative overflow-hidden">
              ...
              <div className="flex items-end gap-2 mb-1">
                <span className="font-noto text-6xl text-white font-[200]">$86</span>
              </div>
            ...
            <div className="bg-white p-10 border-l border-[#E0D5C8]">
              ...
              <p className="font-sans-ui text-[12px] text-[#8B7D72] tracking-wider mb-8">定金 · 当天补 $66 尾款</p>
              <ul className="space-y-3 mb-10">
                {[
                  "先锁定名额",
                  "当天结清尾款",
